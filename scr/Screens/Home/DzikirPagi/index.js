...
render() {
  return (
    <View style={{flex: 1}}>
      <View style={{width:'100%',height:50,justifyContent:'center',alignItems:'center',elevation:3,marginBottom:5,backgroundColor:'white'}}>
        <Text style={{fontWeight:'bold',fontSize:30}}>Dzikir Pagi</Text>
      </View>
