...
render() {
  return (
    <View style={{flex: 1}}>
      <View style={{width:'100%',height:50,alignItems:'center',justifyContent:'center',marginBottom:5,elevation:3,backgroundColor:'white'}}>
        <Text style={{fontSize:30,fontWeight:'bold'}}>Dzikir Petang</Text>
      </View>
      <ScrollView style={{flex: 1}}>
        {this.state.data.map((value, key) => {
          ...
          if (valueKey % 2 == 0) {
            ...
            return (
              <View
                style={{...styles.boxContent, backgroundColor: '#E7FFA1' 
                }}
                key={key}>
                <View style={styles.boxLafaldz}>
                  <Text style={styles.textLafaldz}>{value.lafaldz}</Text>
